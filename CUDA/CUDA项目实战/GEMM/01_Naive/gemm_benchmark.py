...
try:
    lib = load(
        name="gemm_cuda",
        sources=["naive_matrix_multiply.cu"],
        extra_cuda_cflags=[
            "-O3",
...
def plot_performance_comparison():
    ...
    for size in problem_sizes:
        ...
        print(f"  Naive GEMM: {avg_time*1000:.3f} ms")
    ...
    try:
        ...
        xlabel = '问题大小 (矩阵维度)'
        ylabel = '时间 (单位: 秒)'
        title = 'Naive GEMM 性能测试'
    except:
        label = 'My Matrix Multiplication'
        xlabel = 'Problem Size (Matrix Dimension)'
        ylabel = 'Time (seconds)'
        title = 'Naive GEMM Performance Test'
